...
export default function IniciarSesionContraseña({ navigation }) {
  ...
  return(
    <View style={styles.container_blanco}>
        ...
        <Text style={styles.texto_grande}>Iniciando Sesión</Text>

        <Text style={styles.texto_normal}>Ingrese la contraseña que registro</Text>

        <Pressable style={[styles.botones, { marginTop: 20, flexDirection: 'row' }]}>
            <Text style={[styles.texto_normal, { paddingHorizontal: 60 }]}>Ingrese su contraseña</Text>
            <Icon name='eye-slash' size={24} color='#d7d7d7' />
        </Pressable>
